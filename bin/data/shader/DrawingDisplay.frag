...
void main() {
    ...
    } else if (mod(target, SAMPLE_NUM) >= 8.0 && mod(target, SAMPLE_NUM) < 9.0) {
        result = texture2DRect(u_tex8, pos);
    } else if (mod(target, SAMPLE_NUM) >= 9.0 && mod(target, SAMPLE_NUM) < 10.0) {
        result = texture2DRect(u_tex9, pos);
    } else if (mod(target, SAMPLE_NUM) >= 10.0 && mod(target, SAMPLE_NUM) < 11.0) {
        result = texture2DRect(u_tex10, pos);
    } else if (mod(target, SAMPLE_NUM) >= 11.0 && mod(target, SAMPLE_NUM) < 12.0) {
        result = texture2DRect(u_tex11, pos);
    } else if (mod(target, SAMPLE_NUM) >= 12.0 && mod(target, SAMPLE_NUM) < 13.0) {
        result = texture2DRect(u_tex12, pos);
    } else if (mod(target, SAMPLE_NUM) >= 13.0 && mod(target, SAMPLE_NUM) < 14.0) {
        result = texture2DRect(u_tex13, pos);
    } else if (mod(target, SAMPLE_NUM) >= 14.0 && mod(target, SAMPLE_NUM) <= 15.0) {
